...
const SigninForm = () => {
  ...
  return (
    ...
    >
      ...
      <TouchableOpacity
        onPress={async () => await signInOAuth("facebook")}
        style={[
          styles.oauthLoginContainer,
          { backgroundColor: theme.surface, borderColor: theme.border },
        ]}
      >
        <Entypo name="facebook" size={ICON.md} color={theme.text} />
        <Text
          style={[
            styles.oauthLoginText,
      ...
      <TouchableOpacity
        onPress={async () => await signInOAuth("google")}
        style={[
          styles.oauthLoginContainer,
          { backgroundColor: theme.surface, borderColor: theme.border },
        ]}
      >
        <FontAwesome name="google" size={ICON.md} color={theme.text} />
        <Text
          style={[
            styles.oauthLoginText,
            { color: theme.text, fontSize: FONT.body },
      ...
      <View style={styles.dividerContainer}>
        ...
        <Text style={{ color: theme.subText, fontSize: FONT.small }}>
          Or continue with
        </Text>
        <View style={[styles.hr, { backgroundColor: theme.border }]} />
      </View>
